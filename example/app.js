...
function createVNode(tagName, id, classList, data, children, text, element, key) {
  return {
    get tagName() {
      return tagName;
    },
    ...
    get selector() {
      return `${ tagName }${ id && `#${ id }` || '' }` + `${ classList && classList.length > 0 ? '.' + classList.sort().join('') : '' }`;
    },
    ...
    setTagName(tagName) {
      return createVNode(tagName, id, classList, data, children, text, element, key);
    },
...
function emptyVNodeAt(node) {
  return createVNode(node.tagName.toLowerCase(), node.id || '', copy(node.classList), {}, [], '', node, null);
}
...
function convertText(children) {
  return map(function (child) {
    return typeof child === 'string' ? createVNode('', '', [], {}, [], child, null, null) : child;
  }, children);
}
...
function h(selector, data, childrenOrText) {
  ...
  const text = typeof childrenOrText === 'string' ? childrenOrText : '';

  const children = Array.isArray(childrenOrText) ? childrenOrText : [];

  return createVNode(tagName, id, classList, data, tagName === 'svg' ? addNS(children) : convertText(children), text, null, data && data.key || null);
}
...
function parseSelector(selector) {
  ...
  const seed = notClassId.test(tagParts[1]) ? { tagName: 'div', id: '', classList: [] } : { tagName: '', id: '', classList: [] };
...
// eslint-disable-line
const emptyVNode = createVNode('', '', [], {}, [], '', null, null);
...
const appendChild = parent => vNode => {
...
function callInsert(vNode) {
  ...
  const insertedChildren = children.length > 0 ? map(callInsert, children) : children;
...
function init(modules = []) {
  ...
  function callUpdateHooks(oldVNode, vNode) {
    const [updatedOldVNode, updatedVNode] = reduce(function ([oldVNode, vNode], module) {
  ...
  function callCreateHooks(vNode) {
    const updatedVNode = reduce(function (vNode, module) {
  ...
  function createElement(vNode) {
    ...
    const element = data.ns ? document.createElementNS(data.ns, tagName) : document.createElement(tagName);
  ...
  function addVNodes(parent, vNode, before, startIndex, endIndex) {
    ...
    const childrenWithElements = map(function (child, index) {
  ...
  function updateChildren({ parent, oldChildren, vNode, oldKeyToIndex,
    ...
    const _oldKeyToIndex = oldKeyToIndex === null ? createKeyToIndex(oldChildren, oldStartIndex, oldEndIndex) : oldKeyToIndex;
  ...
  return function patch(oldVNode, vNode) {
    ...
    const previousVNode = oldVNode instanceof HTMLElement ? emptyVNodeAt(oldVNode) : oldVNode;
...
var Stream$2 = interopDefault(Stream$1);
...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.mostPrelude = global.mostPrelude || {});
...
var isPromise = _Promise.isPromise;
...
var isPromise = interopDefault(require$$1$1).isPromise;
var base = interopDefault(require$$0$1);
...
var fatalError = createCommonjsModule(function (module) {
/** @license MIT License (c) copyright 2010-2016 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
var fatalError$1 = interopDefault(fatalError);
...
var fatal = interopDefault(require$$1$2);
...
var iterable$1 = interopDefault(iterable);
var makeIterable = iterable.makeIterable;
...
var Stream = interopDefault(require$$6);
var getIterator = interopDefault(require$$1$3).getIterator;
var PropagateTask = interopDefault(require$$0$3);
...
var _ponyfill = interopDefault(require$$0$6);
...
var symbolObservable = interopDefault(require$$0$4).default;
...
var isIterable = interopDefault(require$$1$3).isIterable;
var fromIterable = interopDefault(require$$3$2).fromIterable;
var getObservable = interopDefault(require$$2$1);
var fromObservable = interopDefault(require$$1$4).fromObservable;
var isArrayLike = interopDefault(require$$0$1).isArrayLike;
...
var task$1 = interopDefault(task);
...
var runTask = interopDefault(require$$0$8).runTask;
var Timeline = interopDefault(require$$0$9);
...
var defer = interopDefault(require$$0$8).defer;
...
var defaultScheduler = interopDefault(require$$0$7);
var dispose = interopDefault(require$$3);
var fatalError = interopDefault(require$$1$2);
...
var EventEmitterSource = interopDefault(require$$0$10);
...
var runSource = createCommonjsModule(function (module, exports) {
/** @license MIT License (c) copyright 2010-2016 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
var runSource$1 = interopDefault(runSource);
var withScheduler = runSource.withScheduler;
var withDefaultScheduler = runSource.withDefaultScheduler;
...
var Pipe = interopDefault(require$$4);
var Filter = interopDefault(require$$0$12);
...
var Stream = interopDefault(require$$6);
var Map = interopDefault(require$$0$11);
var Pipe = interopDefault(require$$4);
...
var reduce$2 = accumulate.reduce;
...
var continueWith = interopDefault(require$$0$13).continueWith;
...
var invoke = createCommonjsModule(function (module) {
/** @license MIT License (c) copyright 2010-2016 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
var invoke$1 = interopDefault(invoke);
...
var apply = interopDefault(require$$0$1).apply;
...
var LinkedList = createCommonjsModule(function (module) {
/** @license MIT License (c) copyright 2010-2016 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
var LinkedList$1 = interopDefault(LinkedList);


var require$$1$10 = Object.freeze({
	default: LinkedList$1
});
...
var identity = interopDefault(require$$0$1).id;
...
var mergeConcurrently = interopDefault(require$$0$15).mergeConcurrently;
var mergeMapConcurrently = interopDefault(require$$0$15).mergeMapConcurrently;
...
var Queue$1 = interopDefault(Queue);
...
var base = interopDefault(require$$0$1);
var invoke = interopDefault(require$$1$9);
var Queue = interopDefault(require$$0$16);
...
var Pipe = interopDefault(require$$4);
var dispose = interopDefault(require$$3);
var join = interopDefault(require$$0$14).join;
...
var multicast$1 = createCommonjsModule(function (module, exports) {
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, interopDefault(require$$0$1)) : typeof define === 'function' && define.amd ? define(['exports', '@most/prelude'], factory) : factory(global.mostMulticast = global.mostMulticast || {}, global.mostPrelude);
})(commonjsGlobal, function (exports, _most_prelude) {
  'use strict';
...
var multicast$2 = interopDefault(multicast$1);
...
var flatMap = interopDefault(require$$0$14);
...
var mergeConcurrently = interopDefault(require$$0$15);
...
var multicast = interopDefault(require$$0$17).default;
...
var reduce$1 = most.reduce;
var scan = most.scan;
var loop = most.loop;
var drain = most.drain;
var forEach$1 = most.forEach;
...
const { init, h } = interopDefault(require$$1);
const { fromEvent } = interopDefault(require$$0);

const patch = init([]);

function view(clicks) {
  return h('div.flow', {}, [h('button.btn', {}, 'Click me'), h('h1', {}, 'Clicked ' + String(clicks) + ' times!')]);
}

const click$ = fromEvent('click', document.body).tap(x => console.log(x)).filter(ev => ev.target.matches('.btn'));
